...
function C(n2) {
  if (n2.__P && n2.__d) {
    var u3 = n2.__v, t2 = u3.__e, i3 = [], r2 = [], o2 = w({}, u3);
    o2.__v = u3.__v + 1, l.vnode && l.vnode(o2), z(n2.__P, o2, u3, n2.__n, n2.__P.namespaceURI, 32 & u3.__u ? [t2] : null, i3, null == t2 ? S(u3) : t2, !!(32 & u3.__u), r2), o2.__v = u3.__v, o2.__.__k[o2.__i] = o2, V(i3, o2, r2), u3.__e = u3.__ = null, o2.__e != t2 && M(o2);
  }
}
function M(n2) {
...
function P(n2, l2, u3, t2, i3, r2, o2, e2, f3, c2, s2) {
  var a2, h2, y2, d2, w2, g2, _2, m2 = t2 && t2.__k || v, b = l2.length;
  for (f3 = A(u3, l2, m2, f3, b), a2 = 0; a2 < b; a2++)
    null != (y2 = u3.__k[a2]) && (h2 = -1 != y2.__i && m2[y2.__i] || p, y2.__i = a2, g2 = z(n2, y2, h2, i3, r2, o2, e2, f3, c2, s2), d2 = y2.__e, y2.ref && h2.ref != y2.ref && (h2.ref && D(h2.ref, null, y2), s2.push(y2.ref, y2.__c || d2, y2)), null == w2 && null != d2 && (w2 = d2), (_2 = !!(4 & y2.__u)) || h2.__k === y2.__k ? f3 = H(y2, f3, n2, _2) : "function" == typeof y2.type && void 0 !== g2 ? f3 = g2 : d2 && (f3 = d2.nextSibling), y2.__u &= -7);
  return u3.__e = w2, f3;
}
function A(n2, l2, u3, t2, i3) {
  ...
  if (a2)
    for (r2 = 0; r2 < s2; r2++)
      null != (e2 = u3[r2]) && 0 == (2 & e2.__u) && (e2.__e == t2 && (t2 = S(e2)), E(e2, e2));
  return t2;
}
function H(n2, l2, u3, t2) {
  ...
  if ("function" == typeof n2.type) {
    for (i3 = n2.__k, r2 = 0; i3 && r2 < i3.length; r2++)
      i3[r2] && (i3[r2].__ = n2, l2 = H(i3[r2], l2, u3, t2));
    return l2;
  }
    ...
    if ("style" == l2)
      if ("string" == typeof u3)
        ...
        if ("string" == typeof t2 && (n2.style.cssText = t2 = ""), t2)
          for (l2 in t2)
            u3 && l2 in u3 || j(n2.style, l2, "");
        if (u3)
          for (l2 in u3)
            t2 && u3[l2] == t2[l2] || j(n2.style, l2, u3[l2]);
      }
    else if ("o" == l2[0] && "n" == l2[1])
      r2 = l2 != (l2 = l2.replace(f, "$1")), o2 = l2.toLowerCase(), l2 = o2 in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? o2.slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u3, u3 ? t2 ? u3.u = t2.u : (u3.u = c, n2.addEventListener(l2, r2 ? a : s, r2)) : n2.removeEventListener(l2, r2 ? a : s, r2);
    else {
...
function z(n2, u3, t2, i3, r2, o2, e2, f3, c2, s2) {
  ...
  n:
    if ("function" == typeof T2)
      try {
        if (S2 = u3.props, C2 = T2.prototype && T2.prototype.render, M2 = (a2 = T2.contextType) && i3[a2.__c], $2 = a2 ? M2 ? M2.props.value : a2.__ : i3, t2.__c ? b = (h2 = u3.__c = t2.__c).__ = h2.__E : (C2 ? u3.__c = h2 = new T2(S2, $2) : (u3.__c = h2 = new x(S2, $2), h2.constructor = T2, h2.render = G), M2 && M2.sub(h2), h2.state || (h2.state = {}), h2.__n = i3, p2 = h2.__d = true, h2.__h = [], h2._sb = []), C2 && null == h2.__s && (h2.__s = h2.state), C2 && null != T2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = w({}, h2.__s)), w(h2.__s, T2.getDerivedStateFromProps(S2, h2.__s))), y2 = h2.props, _2 = h2.state, h2.__v = u3, p2)
        ...
        if (h2.context = $2, h2.props = S2, h2.__P = n2, h2.__e = false, I2 = l.__r, A2 = 0, C2)
          h2.state = h2.__s, h2.__d = false, I2 && I2(u3), a2 = h2.render(h2.props, h2.state, h2.context), v.push.apply(h2.__h, h2._sb), h2._sb = [];
        else
          do {
            h2.__d = false, I2 && I2(u3), a2 = h2.render(h2.props, h2.state, h2.context), h2.state = h2.__s;
          } while (h2.__d && ++A2 < 25);
        h2.state = h2.__s, null != h2.getChildContext && (i3 = w(w({}, i3), h2.getChildContext())), C2 && !p2 && null != h2.getSnapshotBeforeUpdate && (m2 = h2.getSnapshotBeforeUpdate(y2, _2)), H2 = null != a2 && a2.type === k && null == a2.key ? q(a2.props.children) : a2, f3 = P(n2, d(H2) ? H2 : [H2], u3, t2, i3, r2, o2, e2, f3, c2, s2), h2.base = u3.__e, u3.__u &= -161, h2.__h.length && e2.push(h2), b && (h2.__E = h2.__ = null);
      } catch (n3) {
        if (u3.__v = null, c2 || null != o2)
          ...
          u3.__e = t2.__e, u3.__k = t2.__k, n3.then || N(u3);
        l.__e(n3, u3, t2);
      }
    else
      null == o2 && u3.__v == t2.__v ? (u3.__k = t2.__k, u3.__e = t2.__e) : f3 = u3.__e = B(t2.__e, u3, t2, i3, r2, o2, e2, c2, s2);
...
function B(u3, t2, i3, r2, o2, e2, f3, c2, s2) {
  var a2, h2, v2, y2, w2, _2, m2, b = i3.props || p, k2 = t2.props, x2 = t2.type;
  ...
  if (null == x2)
    ...
    if (e2 = e2 && n.call(u3.childNodes), !c2 && null != e2)
      for (b = {}, a2 = 0; a2 < u3.attributes.length; a2++)
        b[(w2 = u3.attributes[a2]).name] = w2.value;
    for (a2 in b)
      w2 = b[a2], "dangerouslySetInnerHTML" == a2 ? v2 = w2 : "children" == a2 || a2 in k2 || "value" == a2 && "defaultValue" in k2 || "checked" == a2 && "defaultChecked" in k2 || F(u3, a2, null, w2, o2);
    for (a2 in k2)
      w2 = k2[a2], "children" == a2 ? y2 = w2 : "dangerouslySetInnerHTML" == a2 ? h2 = w2 : "value" == a2 ? _2 = w2 : "checked" == a2 ? m2 = w2 : c2 && "function" != typeof w2 || b[a2] === w2 || F(u3, a2, w2, b[a2], o2);
    if (h2)
      c2 || v2 && (h2.__html == v2.__html || h2.__html == u3.innerHTML) || (u3.innerHTML = h2.__html), t2.__k = [];
    else if (v2 && (u3.innerHTML = ""), P("template" == t2.type ? u3.content : u3, d(y2) ? y2 : [y2], t2, i3, r2, "foreignObject" == x2 ? "http://www.w3.org/1999/xhtml" : o2, e2, f3, e2 ? e2[0] : i3.__k && S(i3, 0), c2, s2), null != e2)
      for (a2 = e2.length; a2--; )
        g(e2[a2]);
...
function E(n2, u3, t2) {
  ...
  if (i3 = n2.__k)
    for (r2 = 0; r2 < i3.length; r2++)
      i3[r2] && E(i3[r2], u3, t2 || "function" != typeof n2.type);
...
function J(u3, t2, i3) {
  var r2, o2, e2, f3;
  t2 == document && (t2 = document.documentElement), l.__ && l.__(u3, t2), o2 = (r2 = "function" == typeof i3) ? null : i3 && i3.__k || t2.__k, e2 = [], f3 = [], z(t2, u3 = (!r2 && i3 || t2).__k = _(k, null, [u3]), o2 || p, p, t2.namespaceURI, !r2 && i3 ? [i3] : o2 ? null : t2.firstChild ? n.call(t2.childNodes) : null, e2, !r2 && i3 ? i3 : o2 ? o2.__e : t2.firstChild, r2, f3), V(e2, u3, f3);
}
function K(n2, l2) {
  J(n2, l2, K);
}
